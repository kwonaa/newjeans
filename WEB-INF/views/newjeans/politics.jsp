...
<%@include file="../includes/header.jsp"%>
        ...
        <!-- 검색폼.end --> 
        		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header noBorder">정치</h3>
			</div>
		</div> 
		<div class="row">
			<div class="col-lg-12">
				<div class="panel panel-default noborder">
					<div class="panel-body" style="position:relative;">
						<table class="table table-hover">
							<c:forEach items="${listpolitics}" var="board">
								<tr>
				   ...
				   <%-- <!-- page번호 출력 ------------------------------------------------------>
		                ...
		                <form id="actionForm" action="/newjeans/politics" method="get">
		                	<input type="hidden" name="pageNum" value="${pageMaker.cri.pageNum}">
		                	<input type="hidden" name="amount" value="${pageMaker.cri.amount}">
		...
		<script>
			$(document).ready(function() {
				...
				$(".paginate_button a").on("click", function(e) {
				    ...
				    actionForm.attr("action","/newjeans/politics"); // 목록으로 전송
			 ...
			 /* $(".move").on("click",function(e) {
		        ...
		        $('#loadMore').on('click', function() {
		            ...
		            $.ajax({
		                url: '/newjeans/politics', // 데이터 요청 URL
		                type: 'GET',
		                data: {
		                    pageNum: pageNum
		                },
