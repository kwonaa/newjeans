...
<%@include file="../includes/header.jsp"%>
		...
		<div class="row">
			<div class="col-lg-12">
				<h3 class="page-header noBorder">경제</h3>
			</div>
		</div>
				...
				<div class="panel panel-default noborder">
					<div class="panel-body" style="position:relative;">
						<table class="table table-hover">
							<c:forEach items="${listfinancial}" var="board">
								<tr>
				   ...
				   <%-- <!-- page번호 출력 ------------------------------------------------------>
		                ...
		                <form id="actionForm" action="/newjeans/financial" method="get">
		                 	<input type="hidden" name="pageNum" value="${pageMaker.cri.pageNum}">
		                  	<input type="hidden" name="amount" value="${pageMaker.cri.amount}">
		...
		<script>
			$(document).ready(function() {
				...
				$(".paginate_button a").on("click", function(e) {
				    ...
				    actionForm.attr("action","/newjeans/financial"); // 목록으로 전송
		...
		/* 		$(".move").on("click",function(e) {
		        ...
		        $('#loadMore').on('click', function() {
		            ...
		            $.ajax({
		                url: '/newjeans/financial', // 데이터 요청 URL
		                type: 'GET',
		                data: {
		                    pageNum: pageNum
		                },
